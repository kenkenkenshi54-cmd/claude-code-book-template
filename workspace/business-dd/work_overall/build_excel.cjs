...
const fys = ['FY2021', 'FY2022', 'FY2023', 'FY2024', 'FY2025'];

// 各期の暦年 (会社別)
const fyToCalYear = {
  copro:     { FY2021: '2021/3', FY2022: '2022/3', FY2023: '2023/3', FY2024: '2024/3', FY2025: '2025/3' },
  nareru:    { FY2021: '2021/10', FY2022: '2022/10', FY2023: '2023/10', FY2024: '2024/10', FY2025: '2025/10' },
  openup:    { FY2021: '2021/6', FY2022: '2022/6', FY2023: '2023/6', FY2024: '2024/6', FY2025: '2025/6' },
  trite:     { FY2021: '-', FY2022: '2022/12', FY2023: '2023/12', FY2024: '2024/12', FY2025: '(予)2025/12' },
  technopro: { FY2021: '2021/6', FY2022: '2022/6', FY2023: '2023/6', FY2024: '2024/6', FY2025: '2025/6' },
};
...
const readmeData = [
  ...
  [''],
  ['■ 重要な制約・前提'],
  ['1. ★ 「過去10年」のフル取得は不可能 (5社中3社が2018年以降のIPO)。本Excelは取得可能な FY2021-FY2025 の5期分を整理。'],
  ['   - コプロ: 2018/3 IPO → 上場後の有報は最大8期分 (FY2018-FY2025)'],
  ['   - ナレル: 2023/7 IPO → 有報は3期分 (FY2023-FY2025)、第5期有報の比較情報でFY2022も取得'],
  ['   - オープンアップ: 旧夢真HD時代から長期取得可能だが2021/4経営統合でセグメント定義変更。本Excelは新体制後 FY2021-FY2025'],
  ['   - トライト: 2023/7 IPO + 2025/9 上場廃止 → 公開期間中の有報は2期分 (FY2023, FY2024) のみ。FY2022は第6期有報の比較情報から取得'],
  ['   - テクノプロ: 2014/12 IPO で長期取得可能。本Excelは FY2021-FY2025'],
  [''],
...
// === 出力 ===
const outPath = path.join(__dirname, '建設技術者派遣5社_セグメント比較_FY21-FY25.xlsx');
