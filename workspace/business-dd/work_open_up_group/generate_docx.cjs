// Convert report_draft.md to docx using the `docx` package (from project root node_modules)
const fs = require('fs');
...
const OUT_FILE = path.resolve(__dirname, '..', 'output', `open_up_group_business_dd_${getDateStr()}.docx`);
