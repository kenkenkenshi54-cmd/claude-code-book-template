// Fetch Asahi Yukizai (4216, secCode "42160") yuho for FY2021-FY2025 via EDINET API v2
...
async function findYuho(year) {
  // Asahi Yukizai is March-end fiscal year; yuho is filed in June (typically late June)
  // Scan June 1 - July 15 for safety
  const months = [
    [6, 1, 30],
    [7, 1, 15],
  ];
...
(async () => {
  ...
  for (const year of [2021, 2022, 2023, 2024, 2025]) {
    console.log(`\n=== Searching yuho filed in ${year} (FY end Mar/${year}) ===`);
