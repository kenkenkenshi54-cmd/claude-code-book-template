// Fetch Omron (6645, secCode "66450") yuho for FY2021-FY2025 via EDINET API v2
...
async function findYuho(year) {
  // Omron is March-end fiscal year; yuho is filed in June (typically late June)
  const months = [
    [6, 15, 30],
    [7, 1, 15],
  ];
